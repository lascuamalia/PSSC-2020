...
namespace StackUnderflow.API.AspNetCore.Controllers
{
    ...
    public class QuestionController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateQuestion([FromBody] CreateQuestionCmd cmd)
        {
            ...
            //adapterii primesc toate datele de care au nevoie de la QuestionWriteContext
            ...
            _dbContext.Questions.Add(new DatabaseModel.Models.Question { QuestionId = Guid.NewGuid(), Titlu = cmd.Titlu, Body = cmd.Body, Tags = cmd.Tags });
