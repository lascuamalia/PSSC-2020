...
namespace FakeSO.API.Rest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // StackUnderflowContext
            services.AddDbContext<DatabaseContextC>(builder =>
            {
                var connection = "Data Source=DESKTOP-2EVIVUQ;Initial Catalog=StackOverflow;Integrated Security=True";
