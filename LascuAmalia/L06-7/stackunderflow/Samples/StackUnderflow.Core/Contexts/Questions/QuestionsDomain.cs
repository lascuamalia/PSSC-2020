...
namespace StackUnderflow.Domain.Core.Contexts.Questions
{
    public static class QuestionsDomain
    {
        ...
        public static Port<ICreateReplyResult> CreateReply(int questionId, Guid authorUserId,Guid questionOwnerId, string body) =>
            NewPort<CreateReplyCmd, ICreateReplyResult>(new CreateReplyCmd(questionId, authorUserId, questionOwnerId, body));
        ...
        public static Port<ISendQuestionOwnerAcknowledgementResult> SendQuestionOwnerAcknowledgement(int questionId, Guid questionOwnerId) =>
        ...
        public static Port<ISendReplyAuthorAcknowledgementResult> SendReplyAuthorAcknowledgement(Guid replyAuthorId, int questionId, Option<ReplyCreated> reply) =>
